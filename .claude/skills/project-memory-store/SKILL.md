...
| `.claude/memory/team/README.md` | Team roles, workflow, communication | Team process changes |
| `.claude/memory/sprint-history/README.md` | Summary of work per sprint | Feature or fix completed |
